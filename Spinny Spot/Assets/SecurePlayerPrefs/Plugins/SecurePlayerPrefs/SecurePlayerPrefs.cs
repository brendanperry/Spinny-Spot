...
namespace SecPlayerPrefs
{
    public class SecurePlayerPrefs : ScriptableObject
    {
        ...
        private static byte[] keyArray = UTF8Encoding.UTF8.GetBytes("Xj0CptXzCXo6o0VEyFjACqJWbjP4kIHg"); // 256-AES key Replace with your own
        ...
        public static string GetString(string Key, string defaultValue)
        {
            if(!SecurePlayerPrefs.HasKey(Key)) {
                SecurePlayerPrefs.SetString(Key, defaultValue);
            }
        ...
        {
            if (!SecurePlayerPrefs.HasKey(Key)) {
                SecurePlayerPrefs.SetInt(Key, defaultValue);
            }
        ...
        {
            if (!SecurePlayerPrefs.HasKey(Key)) {
                SecurePlayerPrefs.SetFloat(Key, defaultValue);
            }
